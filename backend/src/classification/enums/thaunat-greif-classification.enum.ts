export enum LesionType {
  Type1 = 'Tipo 1: Lesão completa da junção capsulo sinovial',
  Type2 = 'Tipo 2: Lesão parcial superior na zona vermelha',
  Type3 = 'Tipo 3: Lesão parcial inferior',
  Type4 = 'Tipo 4: Lesão completa',
  Type5 = 'Tipo 5: Lesão completa dupla',
}

export enum LesionVariation {
